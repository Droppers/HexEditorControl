...
internal class HexControlPropertyMapper : PropertyMapper<SharedHexControl>
{
    public HexControlPropertyMapper(SharedHexControl control, INativeFactory factory) : base(control, factory)
    {
        ...
        Add(nameof(control.Background), value => control.Background = value, () => control.Background, MappingType.Brush);
        Add(nameof(control.HeaderForeground), value => control.HeaderForeground = value, () => control.HeaderForeground, MappingType.Brush);
        Add(nameof(control.OffsetForeground), value => control.OffsetForeground = value, () => control.OffsetForeground, MappingType.Brush);
        ...
        Add(nameof(control.Margin), value => control.Margin = value, () => control.Margin);

        Add(nameof(control.OffsetHeader), value => control.OffsetHeader = value, () => control.OffsetHeader);
        Add(nameof(control.TextHeader), value => control.TextHeader = value, () => control.TextHeader);
    }
}