...
namespace HexControl.PatternLanguage.Visualization
{
    public class ConsoleVisualizer
    {
        ...
        private void VisualizeVariable(PatternData pattern, string? content = null, bool write = false, bool nextNoIndent = false)
        {
            var endian = "";
            if (pattern.Endian is Endianess.Little)
            {
            ...
            Print($"{endian}{pattern.GetFormattedName()} {pattern.VariableName} = {content}{(content is null ? "" : ";")}", write);
