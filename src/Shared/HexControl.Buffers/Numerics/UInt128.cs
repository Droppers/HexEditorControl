...
namespace HexControl.Buffers.Numerics;
...
public struct UInt128 : IFormattable, IComparable, IComparable<UInt128>, IEquatable<UInt128>
{
    ...
    private struct UInt256
    {
        ...
        public static implicit operator BigInteger(UInt256 a) => ((BigInteger)a.s3 << 192) | ((BigInteger)a.s2 << 128) |
                                                                 ((BigInteger)a.s1 << 64) | a.s0;
    ...
    public static UInt128 Zero => MinValue;
    ...
    public UInt128(ulong value1, ulong value2)
    {
        Create(out this, value1, value2);
    }
    ...
    public static void Create(out UInt128 c, long a, long b)
    {
        c.s0 = (ulong)a;
        c.s1 = (ulong)b;
    }
    ...
    private const int MAX_REP_SHIFT = 53;
    private static readonly ulong MaxRep = (ulong)1 << MAX_REP_SHIFT;
    private static readonly UInt128 MaxRepSquaredHigh = (ulong)1 << (2 * MAX_REP_SHIFT - 64);
    ...
    public static double Log(UInt128 a, double b = Math.E) => Math.Log(ConvertToDouble(ref a), b);
