...
namespace HexControl.Core.Numerics
{
    public struct UInt128 : IFormattable, IComparable, IComparable<UInt128>, IEquatable<UInt128>
    {
        ...
        private struct UInt256
        {
            ...
            public UInt128 t0 { get {
                UInt128.Create(out var result, s0, s1); return result; } }
            public UInt128 t1 { get {
                UInt128.Create(out var result, s2, s3); return result; } }
        ...
        {
            return obj is UInt128 int128 && Equals(int128);
        }
        ...
        public static double Log(UInt128 a, double b = Math.E)
        {
